...
SVGTextAnimate.prototype.animate = function animate (svgDom, options) {
...
SVGTextAnimate.prototype.create = function create (text, selector, duration, options) {
  var _this = this;
  var paths = _this.font.getPaths(text, 0, _this.fontsize, _this.fontsize);
  var box = _this.getBoundingBox(paths);
  var svg = "<svg width=\"" + (box.x2 - box.x1) + "\" height=\"" + (box.y2 - box.y1) + "\" viewBox=\"" + (box.x1) + " " + (box.y1) + " " + (box.x2) + " " + (box.y2) + "\" xmlns=\"http://www.w3.org/2000/svg\"><g id=\"svgGroup\" stroke-linecap=\"round\" fill-rule=\"evenodd\" font-size=\"72px\" stroke=\"#000\" stroke-width=\"1px\" fill=\"none\" style=\"stroke:#000;stroke-width:1px;fill:none\"></g></svg>";
  var fatherdom = document.querySelector(selector);
  fatherdom.innerHTML = svg;

  var svgDom = fatherdom.querySelector("svg");
