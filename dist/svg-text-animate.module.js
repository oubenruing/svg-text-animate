...
(function (MakerJs) {
     ...
     * @private
     */
    var kdbush$1 = (_kdbush["default"] || _kdbush);
    /**
    ...
    var PointGraph = /** @class */ (function () {
        ...
        PointGraph.prototype.mergeNearestSinglePoints = function (withinDistance) {
            ...
            this.kdbush = kdbush$1(singles.map(function (el) { return el.point; }));
...
(function (MakerJs) {
    ...
    (function (measure) {
         ...
         * @private
         */
        var graham_scan = graham_scan_min;
        /**
         * @private
         */
...
(function (MakerJs) {
    ...
    (function (models) {
        ...
        function getScratch(seed) {
            ...
            if (!scratch) {
                ensureBezierLib();
                scratch = new bezierJs(bezierJsPoints);
            }
            else {
                //invoke the constructor on the same object
                bezierJs.apply(scratch, bezierJsPoints);
            }
            return scratch;
        }
        /**
...
SVGTextAnimate.prototype.setFont = function setFont (fontfile) {
  ...
  return new Promise(function(resove,reject){
    load(_this.fontfile, function (err, openfont) {
      if (err) {
...
SVGTextAnimate.prototype.create = function create (text, fatherdom, fontsize) {
  var _this = this;
  var textModel = new dist.models.Text(_this.font, text, fontsize || 72);
  var svg = dist.exporter.toSVG(textModel);
