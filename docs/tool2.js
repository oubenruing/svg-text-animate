...
var SVGTextAnimate = (function () {
	...
	*****/
	...
	SVGTextAnimate.prototype.createSVGDom = function createSVGDom (text) {
	  ...
	  var svg = 
	    "<svg width=\"" + (box.x2 - box.x1 +strokeWidth+0.5) + "\" \n            height=\"" + (box.y2 - box.y1) + "\" \n            viewBox=\"" + (box.x1) + " " + (box.y1) + " " + (box.x2 + strokeWidth+0.5) + " " + (box.y2 +strokeWidth) + "\"\n            xmlns=\"http://www.w3.org/2000/svg\" data-copyright=\"https://github.com/oubenruing/svg-text-animate\" style=\"vertical-align: text-top; \">\n          <g id=\"svgGroup\" stroke-linecap=\"round\" stroke=\"" + (this.stroke.stroke) + "\" stroke-width=\"" + strokeWidth + "\" fill=\"" + (this.stroke.stroke) + "\">\n          </g>\n      </svg>";
